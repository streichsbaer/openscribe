...
final class StatusBarController: NSObject {
    ...
    private static let activeIndicatorSize = NSSize(width: 56, height: 56)
    private static let activeIndicatorIconSize = NSSize(width: 34, height: 34)
    private static let activeIndicatorBottomInset: CGFloat = 38
    ...
    private func configureActiveIndicator() {
        ...
        let visualEffectView = NSVisualEffectView(frame: NSRect(origin: .zero, size: Self.activeIndicatorSize))
